...
function Register() {
  ...
  return (
    <div
      className={clsx(classes.root, 'flex flex-col flex-auto items-center  flex-shrink-1')}
      width="100%"
    >
      <motion.div
          ...
          <CardContent className="flex flex-col items-center justify-center w-full max-w-320">
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1, transition: { delay: 0.2 } }}>
              <div className="flex items-center justify-center  mt-72">
                <img className="logo-icon " width={80} src="https://media.licdn.com/dms/image/D560BAQFlXFQ3alWjGg/company-logo_200_200/0/1666766538054?e=1703116800&v=beta&t=H0KF38Ovts0__sTx4dg9TfWPg8UeaLvj8ItQOYyP1h4" alt="logo" />
